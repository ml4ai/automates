...
3) **Comment handling.** We have extended our handling of comments to include both function-level and intra-function comments.  This necessitated developing a way to associate intra-function comments with semantics-preserving markers that we could insert into the ASTs generated by `OFP`.
