...
class TestDefinitions extends ExtractionTest {
  ...
  passingTest should "find definitions from t7" in {
    val desired = Map(
      "Ta" -> Seq("water uptake"),
  ...
  passingTest should "find definitions from t10" in {
    val desired = Map(
  ...
  passingTest should "find definitions from t11" in {
    val desired = Map(
  ...
  passingTest should "find NO definitions from t12" in {
    val desired = Map.empty[String, Seq[String]]
  ...
  passingTest should "find definitions from t13" in {
    val desired = Map(
  ...
  passingTest should "find NO definitions from t14" in {
    val desired =  Map.empty[String, Seq[String]]
  ...
  passingTest should "find NO definitions from t15" in {
    val desired =  Map.empty[String, Seq[String]]
  ...
  passingTest should "find NO definitions from t16" in {
    val desired =  Map.empty[String, Seq[String]]
  ...
  passingTest should "find definitions from t17" in {
    val desired = Map(
