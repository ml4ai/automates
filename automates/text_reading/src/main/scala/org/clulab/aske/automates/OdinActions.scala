...
//    for (g <- intervalMentionMap.toMap) {
//      println(g._1)
//      for (m <- g._2) {
...
//    println("USED FOR no overlap in given arg")
...
//    println("USED IN filter out overlapping descr mentions")
...
//    println("USED IN untangle conjunctions")
    val toReturn = new ArrayBuffer[Mention]()
