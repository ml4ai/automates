...
class ModelImport(object):
    ...
    swagger_types = {
        'name': 'str',
        'type': 'ComponentsschemasImportType',
        'version': 'str',
        'uri': 'str'
    }
    ...
    @property
    def type(self):
        """Gets the type of this ModelImport.  # noqa: E501


        :return: The type of this ModelImport.  # noqa: E501
        :rtype: ComponentsschemasImportType
        """
        return self._type

    @type.setter
    def type(self, type):
        """Sets the type of this ModelImport.


        :param type: The type of this ModelImport.  # noqa: E501
        :type: ComponentsschemasImportType
        """
    ...
    @property
    def version(self):
        """Gets the version of this ModelImport.  # noqa: E501
        ...
        :return: The version of this ModelImport.  # noqa: E501
        :rtype: str
        """
    ...
    def version(self, version):
        """Sets the version of this ModelImport.

        The import source name and version (if available) of the element being imported. For example, if important a native library from Python 3.10, then this would be \"Python 3.10\".   # noqa: E501

        :param version: The version of this ModelImport.  # noqa: E501
        :type: str
        """
    ...
    @property
    def uri(self):
        """Gets the uri of this ModelImport.  # noqa: E501

        A URI referring to the source import module. Examples: (1) LIBRARY:      {\"name\": \"numpy.concatenate\",       \"type\": \"LIBRARY\",       \"version\": \"Numpy 1.23.0\",       \"uri\": \"https://numpy.org/\"}. (2) Exisitng GrometFNModule (GROMET_FN_MODULE):      {\"name\": \"model.sir.get_growth_rate: <index_to_FN_in_GrometFNModule_attributes_array>\",       \"type\": \"GROMET_FN_MODULE\",       \"uri\": \"<location of GrometFNModule JSON>\"}   # noqa: E501

        :return: The uri of this ModelImport.  # noqa: E501
        :rtype: str
        """
        return self._uri
    ...
    @uri.setter
    def uri(self, uri):
        """Sets the uri of this ModelImport.

        A URI referring to the source import module. Examples: (1) LIBRARY:      {\"name\": \"numpy.concatenate\",       \"type\": \"LIBRARY\",       \"version\": \"Numpy 1.23.0\",       \"uri\": \"https://numpy.org/\"}. (2) Exisitng GrometFNModule (GROMET_FN_MODULE):      {\"name\": \"model.sir.get_growth_rate: <index_to_FN_in_GrometFNModule_attributes_array>\",       \"type\": \"GROMET_FN_MODULE\",       \"uri\": \"<location of GrometFNModule JSON>\"}   # noqa: E501

        :param uri: The uri of this ModelImport.  # noqa: E501
        :type: str
        """
