...
class TextParameter(Metadata):
    ...
    def text_extraction(self, text_extraction):
        ...
        if text_extraction is None:
            raise ValueError("Invalid value for `text_extraction`, must not be `None`")  # noqa: E501
    ...
    def variable_identifier(self, variable_identifier):
        ...
        if variable_identifier is None:
            raise ValueError("Invalid value for `variable_identifier`, must not be `None`")  # noqa: E501
