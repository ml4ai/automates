...
class SourceCodeDataType(Metadata):
    ...
    def __init__(self, metadata_type='source_code_data_type', source_language=None, source_language_version=None, data_type=None, *args, **kwargs):  # noqa: E501
    ...
    def source_language_version(self, source_language_version):
        ...
        :type: str
        """
        if source_language_version is None:
            raise ValueError("Invalid value for `source_language_version`, must not be `None`")  # noqa: E501
    ...
    def data_type(self):
        ...
        The source code data type as named by the source language. E.g., \"int_8\", \"Float64\", etc...   # noqa: E501
