...
def Sequence_get(sequence_input: Sequence, index: DimensionalIndex) -> Sequence:
    if isinstance(index, Slice): 
        return sequence_input[index.lower:index.upper:index.step]
    elif isinstance(index, ExtendedSlice):
        pass
