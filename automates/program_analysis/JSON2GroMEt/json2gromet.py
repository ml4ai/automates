...
def json_to_gromet(path):
    ...
    # Import Metadata
    for collection in json_object["metadata_collections"]:
        ...
        if not gromet_module.metadata_collection:
            gromet_module.metadata_collections = [gromet_metadata_collection]
        else:
            gromet_module.metadata_collections.append(gromet_metadata_collection)
