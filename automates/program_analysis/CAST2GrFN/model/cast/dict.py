...
class Dict(AstNode):
    ...
    """
    swagger_types = {"keys": "list[AstNode]", "values": "list[AstNode]"}
    if hasattr(AstNode, "swagger_types"):
        swagger_types.update(AstNode.swagger_types)

    attribute_map = {"keys": "keys", "values": "values"}
    if hasattr(AstNode, "attribute_map"):
        attribute_map.update(AstNode.attribute_map)

    def __init__(self, keys=None, values=None, *args, **kwargs):  # noqa: E501
        """Dict - a model defined in Swagger"""  # noqa: E501
        self._keys = None
        self._values = None
    ...
    @property
    def keys(self):
        """Gets the keys of this Dict.  # noqa: E501


        :return: The keys of this Dict.  # noqa: E501
        :rtype: list[AstNode]
        """
        return self._keys
    ...
    @keys.setter
    def keys(self, keys):
        """Sets the keys of this Dict.


        :param keys: The keys of this Dict.  # noqa: E501
        :type: list[AstNode]
        """
    ...
    @property
    def values(self):
        """Gets the values of this Dict.  # noqa: E501


        :return: The values of this Dict.  # noqa: E501
        :rtype: list[AstNode]
        """
        return self._values
    ...
    def values(self, values):
        """Sets the values of this Dict.


        :param values: The values of this Dict.  # noqa: E501
        :type: list[AstNode]
        """
