...
class Boolean(AstNode):
    ...
    """
    swagger_types = {"boolean": "bool"}
    if hasattr(AstNode, "swagger_types"):
        swagger_types.update(AstNode.swagger_types)

    attribute_map = {"boolean": "boolean"}
    if hasattr(AstNode, "attribute_map"):
        attribute_map.update(AstNode.attribute_map)

    def __init__(self, boolean=None, *args, **kwargs):  # noqa: E501
        """Boolean - a model defined in Swagger"""  # noqa: E501
        self._boolean = None
    ...
    @property
    def boolean(self):
        """Gets the boolean of this Boolean.  # noqa: E501
    ...
    def boolean(self, boolean):
        """Sets the boolean of this Boolean.


        :param boolean: The boolean of this Boolean.  # noqa: E501
        :type: bool
        """
