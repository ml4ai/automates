...
class ModelIf(AstNode):
    ...
    attribute_map = {"expr": "expr", "body": "body", "orelse": "orelse"}
    if hasattr(AstNode, "attribute_map"):
        attribute_map.update(AstNode.attribute_map)

    def __init__(
        self, expr=None, body=None, orelse=None, *args, **kwargs
    ):  # noqa: E501
        """ModelIf - a model defined in Swagger"""  # noqa: E501
        self._expr = None
        self._body = None
        self._orelse = None
        ...
        # version in updated_variables field inherited from AstNode
        # We will create the conditional variable for this decision node
        # based on `expr` sometime later, but its outputs will be the
        # `updated_variables` stored at this node

    @property
    def expr(self):
        """Gets the expr of this ModelIf.  # noqa: E501


        :return: The expr of this ModelIf.  # noqa: E501
        :rtype: AstNode
        """
        return self._expr
    ...
    @expr.setter
    def expr(self, expr):
        """Sets the expr of this ModelIf.


        :param expr: The expr of this ModelIf.  # noqa: E501
        :type: AstNode
        """
    ...
    @property
    def body(self):
        """Gets the body of this ModelIf.  # noqa: E501


        :return: The body of this ModelIf.  # noqa: E501
        :rtype: list[AstNode]
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this ModelIf.


        :param body: The body of this ModelIf.  # noqa: E501
        :type: list[AstNode]
        """
    ...
    @property
    def orelse(self):
        """Gets the orelse of this ModelIf.  # noqa: E501
    ...
    def orelse(self, orelse):
        """Sets the orelse of this ModelIf.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModelIf):
            return False
