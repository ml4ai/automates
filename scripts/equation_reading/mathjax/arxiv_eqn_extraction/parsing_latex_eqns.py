    ...
    for i, eq in enumerate(eq_dict):
        if len(eq)!=0:
            ...
            if cleaned_eq not in src_latex:
                ...
                if LargeFlag:
                    with open(os.path.join(root,f'latex_equations/{tex_folder}/Large_eqns/eqn{i}.txt'), 'w') as file:
                    ...
                    with open(os.path.join(root, f'latex_equations/{tex_folder}/Small_eqns/eqn{i}.txt'), 'w') as file:
...
if __name__ == "__main__":
    ...
    excel_file = '/home/u17/gauravs/automates_scripts/Latex_symbols.xlsx'
    ...
    src_path = '/xdisk/claytonm/projects/automates/arxiv/src'
    ...
    results_dir = f'/xdisk/claytonm/projects/automates/er/gaurav/{DIR}'
    ...
    json.dump(unknown_encoding_tex, open(os.path.join(results_dir, 'unknown_encoding_tex.txt'),"w" ))
    lock.release()
