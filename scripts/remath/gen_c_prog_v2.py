...
def mytest_var_gen():
    ...
    assert var_gen.is_var('x10') is False
    ...
    assert var_gen.is_var('xy8') is False
...
class ExprSeqSample:
    ...
    def sample(self, verbose_p=False):
        ...
        for i in range(num_expressions):
            ...
            # ensure current expression is referred to by at least one of the previous
    ...
    def assign_var_literal_assignments(self, expr_seq_sample: ExprSeqSample):
        ...
        This fn does the following:
            For each operator
                ...
                Assign at least one var_literal_assignment to a randomly chosen assigned.
