...
python batch_tokenize_instructions_v2.py -I expr_v2_perfect/expr_v2_0236810-large \
...
python batch_tokenize_instructions_v2.py -I expr_v2_perfect -D expr_v2_perfect/output