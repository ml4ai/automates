...
def cond_ex1_gromet() -> Gromet:
    ...
    wires = [
        ...
        # Branch 1
        # input
        WireDirected(uid=UidWire("W:cond1.y"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:conditional.in.y'),
                     output=UidPort('P:cond1.in.y')),
        WireDirected(uid=UidWire("W:c1.x"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:conditional.in.x'),
                     output=UidPort('P:c1.in.x')),
        WireDirected(uid=UidWire("W:c1.y"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:conditional.in.x'),
                     output=UidPort('P:c1.in.y')),
        # output
        WireDirected(uid=UidWire("W:c1.z"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:c1.out.z'),
                     output=UidPort('P:conditional.out.z')),

        # Branch 1 : c1
        WireDirected(uid=UidWire("W:c1_c1exp.x"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:c1.in.x'),
                     output=UidPort('P:c1_exp.in.x')),
        WireDirected(uid=UidWire("W:c1_c1exp.y"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:c1.in.y'),
                     output=UidPort('P:c1_exp.in.7')),
        WireDirected(uid=UidWire("W:c1_c1exp.z"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
        ...
        # Branch 2
        # input
        WireDirected(uid=UidWire("W:c2.y"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:conditional.in.y'),
                     output=UidPort('P:c2.in.y')),
        # output
        WireDirected(uid=UidWire("W:c2.z"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:c2.out.z'),
                     output=UidPort('P:conditional.out.z')),

        # Branch 2 : c2
        WireDirected(uid=UidWire("W:c2.y_z"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
        ...
        # cond_ex1
        # input
        WireDirected(uid=UidWire("W:cond_ex1.x"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:cond_ex1.in.x'),
                     output=UidPort('P:conditional.in.x')),
        WireDirected(uid=UidWire("W:cond_ex1.y"), type=UidType("T:Integer"),
                     name=None, value=None, metadata=None,
                     input=UidPort('P:cond_ex1.in.y'),
                     output=UidPort('P:conditional.in.y')),
        # output
        WireDirected(uid=UidWire("W:cond_ex1.z"), type=UidType("T:Float"),
                     name=None, value=None, metadata=None,
    ...
    ports = [
        ...
        Port(uid=UidPort('P:cond1.in.y'), box=UidBox('B:cond1'),
             type=UidType('T:Integer'), name='y',
             value=None, metadata=None),
        # output for 'cond1'
        Port(uid=UidPort('P:cond1.out.c1'), box=UidBox('B:cond1'),
             type=UidType('T:Boolean'), name='c1',
             value=None, metadata=None),
