...
def test_class_1():
    ...
    a1 = Assignment(left=Attribute(value=Name("self"),attr=Name("x")),right=Number(1))
    a2 = Assignment(left=Attribute(value=Name("self"),attr=Name("y")),right=Number(2))
...
def test_list_2():
    ...
    v1 = Var(val=Name("x"),type="integer")
    a1 = Assignment(left=v1,right=List(values=[Number(1),Number(2),Number(3),Number(4)]))
...
def test_add_1():
    ...
    add1 = Expr(BinaryOp(op=BinaryOperator.ADD,left=Number(1),right=Number(2)))
...
def test_add_2():
    ...
    sub1 = BinaryOp(op=BinaryOperator.SUB,left=Number(1),right=Name(name="y"))
...
def test_for_1():
    ...
    loop_cond = BinaryOp(BinaryOperator.LT,Name("i_"),Call(Name("len"),[Name("y")]))
    loop_assign = Assignment(Var(Name("i"),"integer"),Subscript(Name("y"),Name("i_")))
...
def test_while_1():
    ...
    loop_cond = BinaryOp(BinaryOperator.LT,Name("i"),Call(Name("len"),[Name("b")]))
    loop_assign = Assignment(v3,Subscript(Name("b"),Name("i")))
    loop_increment = Assignment(v2,BinaryOp(BinaryOperator.ADD,Name("i"),Number(1)))
