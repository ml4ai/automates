!=======================================================================
!  WH_OPHARV, Subroutine C.H. Porter
!  Generates data for use by OPSUM and OVERVIEW for WHAPS wheat.
!-----------------------------------------------------------------------
!  REVISION HISTORY
...
!-----------------------------------------------------------------------
	...
	CHARACTER*80 PATHEX
      ...
      REAL AGEFAC, APTNUP, BWAH, BWAM, CANNAA, CANWAA, PLTPOP
...
!*!  &  'Harvest   '/   !20
      ...
      DATA STNAME / !numbered order from Table 2, nwheat_science.doc
