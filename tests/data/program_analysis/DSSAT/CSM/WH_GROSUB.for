...
! Need to output the ptnup and ctnup
      ...
      SUBROUTINE WH_GROSUB (CONTROL, ISWITCH, WEATHER, XSTAGE, 
...
!**
          ...
          IF (ISWNIT .NE. 'N') THEN
             CALL WH_NFACTO(DYNAMIC,TANC,TCNP,TMNC,
...
!         CHP 7/29/2008
          ...
          IF (ISWNIT .NE. 'N' .AND. ISTAGE .LT. 7) THEN
              CALL WH_NFACTO(DYNAMIC,                 !Control
...
!======================================================================
      IF (ISWNIT .NE. 'N') THEN
         ...
         CALL  nwheats_set_nfact (xstag_nw, istage,              !Input 
...
! WH_GROSUB calculate Nitrogen uptake and passed to plant.for
