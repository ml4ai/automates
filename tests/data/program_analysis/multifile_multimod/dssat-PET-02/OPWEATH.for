...
C-----------------------------------------------------------------------
      ...
      WRITE (*,10) "... Entering subroutine OPWEATH"
 10   FORMAT(A)
...
!     VSH
C      IF (FMOPT == 'C') THEN 
C         CALL CsvOutWth(EXPNAME, RUN, CONTROL%TRTNUM, 
C     &CONTROL%ROTNUM, CONTROL%REPNO, YEAR, DOY, DAS,  
C     &RAIN, DAYL, TWILEN, SRAD, PAR, CLOUDS, TMAX,  
C     &TMIN, TAVG, TDAY, TDEW, TGROAV, TGRODY, WINDSP, CO2,
C     &VPDF, vpd_transp,   
C     &vCsvlineWth, vpCsvlineWth, vlngthWth)
C     
C         CALL LinklstWth(vCsvlineWth)
C      END IF
...
!***********************************************************************
      ENDIF
!***********************************************************************
      WRITE (*,10) "... Leaving subroutine OPWEATH"
