...
C        IF (ABS(WTHADJ(1,1)) .GT. 0.001 .OR. 
C     &          ABS(WTHADJ(2,1) - 1.) .GT. 0.0001) THEN
C          DAYL = WTHADJ(1,1) + DAYL*WTHADJ(2,1)
C          SNUP = 12.0 - DAYL/2.0
C          SNDN = 12.0 + DAYL/2.0
C          DEC = DECL(DAYL,XLAT)
C          TWILEN = WTHADJ(1,1) + TWILEN*WTHADJ(2,1)
C        ENDIF
