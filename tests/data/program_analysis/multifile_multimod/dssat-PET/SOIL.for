...
C      IF (MESOM .EQ. 'P') THEN
!       Parton (Century-based) soil organic matter module
C        CALL CENTURY(CONTROL, ISWITCH, 
C     &    FERTDATA, FLOODWAT, FLOODN, HARVRES, NH4,       !Input
C     &    NO3, OMADATA, SENESCE, SOILPROP, SPi_Labile,    !Input
C     &    SRFTEMP, ST, SW, TILLVALS,                      !Input
C     &    IMM, LITC, MNR, MULCH, SomLit, SomLitC,         !Output
C     &    SomLitE, SSOMC,                                 !Output
C     &    newCO2)                                         !for DayCent in SOILNI added by PG
C      ELSE
