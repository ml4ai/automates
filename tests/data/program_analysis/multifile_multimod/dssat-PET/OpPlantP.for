...
C         CALL CsvOutPlantP(EXPNAME, CONTROL%RUN, CONTROL%TRTNUM, 
C     &CONTROL%ROTNUM, CONTROL%REPNO, YEAR, DOY, DAS, DAP, 
C     &PConc_Shut_opt, PConc_Root_opt, PConc_Shel_opt, PConc_Seed_opt, 
C     &PConc_Shut_min, PConc_Root_min, PConc_Shel_min, PConc_Seed_min, 
C     &PConc_Shut, PConc_Root, PConc_Shel, PConc_Seed, PConc_Plant, 
C     &PShut_kg, PRoot_kg, PShel_kg, PSeed_kg, PPlant_kg, PS1_AV, PS2_AV,
C     &PUptakeProf, PUptake_Cum, CumSenSurfP, CumSenSoilP, PhFrac1, 
C     &PhFrac2, Shut_kg, Root_kg, Shel_kg, Seed_kg, PSTRESS_RATIO, N2P, 
C     &PTotDem,    
C     &vCsvlinePlantP, vpCsvlinePlantP, vlngthPlantP)
C     
C         CALL LinklstPlantP(vCsvlinePlantP)
C      END IF
