...
C            CALL CsvOutET(EXPNAME,CONTROL%RUN, CONTROL%TRTNUM,
C     &CONTROL%ROTNUM,CONTROL%REPNO, YEAR, DOY, DAS, 
C     &AVSRAD, AVTMX, AVTMN, EOAA, EOPA, EOSA, ETAA, EPAA, ESAA, EFAA, 
C     &EMAA, CEO, CET, CEP, CES, CEF, CEM, N_LYR, ES_LYR, TRWU,
C     &vCsvlineET, vpCsvlineET, vlngthET)
C     
C            CALL LinklstET(vCsvlineET)
          ENDIF
