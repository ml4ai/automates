...
C     Transfer values from constructed data types into local variables.
      ...
      WRITE (*,10) "ENTERING SUBROUTINE LAND"
 10   FORMAT(A)
...
C 
C C-----------------------------------------------------------------------
C C     Read input parameters for weather routines
C C-----------------------------------------------------------------------
C       CALL WEATHR(CONTROL, ISWITCH, WEATHER, YREND)
C 
C C-----------------------------------------------------------------------
C C     Read initial soil data 
C C-----------------------------------------------------------------------
...
C 
C C-----------------------------------------------------------------------
C C     Read initial soil-plant-atmosphere data
C C-----------------------------------------------------------------------
...
C C***********************************************************************
C       ELSE IF (DYNAMIC .EQ. RATE) THEN
C C-----------------------------------------------------------------------
C C     Call WEATHER Subroutine to input weather data and to
C C     calculate hourly radiation and air temperature values
C C     Note: First day of weather has already been read by 
C C       initialization call to WEATHR.
C C-----------------------------------------------------------------------
C       CALL WEATHR(CONTROL, ISWITCH, WEATHER, YREND)
C 
C C-----------------------------------------------------------------------
...
C C     Daily Output
C C***********************************************************************
C       ELSE IF (DYNAMIC .EQ. OUTPUT) THEN
C 
C       CALL WEATHR(CONTROL, ISWITCH, WEATHER, YREND)
C 
C         CALL SOIL(CONTROL, ISWITCH, 
