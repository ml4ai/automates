 ...
 */
double PI_calc_antiwindup(double Input_dmd, double Input_sensed, double Kp_M, double Ki_M, double timestep)
{
...
int main(int argc, char **argv)
{
    ...
    {
        plant_command = PI_calc_antiwindup(desired_output, sensed_output, Kp_M, Ki_M, time_step);
