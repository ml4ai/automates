...
def gillespie(
    ...
    for runs[0] in range(0, (total_runs[0] - 1) + 1):
        ...
        while (t[0] <= tmax[0]) and (i[0] > 0):
            ...
            t[0] = t[0] + dt[0]
            while (sample_idx[0] < tmax[0]) and (
                t[0] > samples.get_((sample_idx[0]))
            ):
                ...
                means.set_(
                    ...
                    Float32(
                        (
                            means.get_((samp[0]))
                            + ((n_s[0] - means.get_((samp[0]))) / runs1[0])
                        )
                    ),
                )
                vars.set_(
                ...
                meani.set_(
                    ...
                    Float32(
                        (
                            meani.get_((samp[0]))
                            + ((n_i[0] - meani.get_((samp[0]))) / runs1[0])
                        )
                    ),
                )
                vari.set_(
                ...
                meanr.set_(
                    ...
                    Float32(
                        (
                            meanr.get_((samp[0]))
                            + ((n_r[0] - meanr.get_((samp[0]))) / runs1[0])
                        )
                    ),
                )
                varr.set_(
